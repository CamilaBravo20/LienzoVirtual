...
class Window(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Aplicación Lienzo Virtual")
        ...
        brushMenu = mainMenu.addMenu("Tamaño del Pince")
        brushColor = mainMenu.addMenu("Color del Pince")
        ...
        clearAction = QAction(QIcon("icons/clear.png"), "Limpiar", self)
        ...
        blackAction = QAction(QIcon("icons/black.png"), "Negro", self)
        blackAction.setShortcut("Ctrl+B")
        brushColor.addAction(blackAction)
        blackAction.triggered.connect(self.blackColor)

        whiteAction = QAction(QIcon("icons/white.png"), "Blanco" , self)
        whiteAction.setShortcut("Ctrl+W")
        brushColor.addAction(whiteAction)
        whiteAction.triggered.connect(self.whiteColor)

        redAction = QAction(QIcon("icons/red.png"), "Rojo", self)
        redAction.setShortcut("Ctrl+R")
        brushColor.addAction(redAction)
        redAction.triggered.connect(self.redColor)

        greenAction = QAction(QIcon("icons/green.png"), "Verde", self)
        greenAction.setShortcut("Ctrl+G")
        brushColor.addAction(greenAction)
        greenAction.triggered.connect(self.greenColor)

        yellowAction = QAction(QIcon("icons/yellow.png"), "Amarillo", self)
